...
//! identity, open the store, publish prekeys, open the direct message, post.
//! The store is the real one under `~/.sqex/chat`, so the message is in the
//! identity's own history afterwards, as it would be had it been typed.
