...
enum Cmd {
    ...
    Peers,
    /// The exchange's earlier keys (SIP-40 §Lineage): the SIP-40 handovers it has
...
async fn fetch_one(
    ...
    // SIP-5 §Collection by a device: a device is shown its account's mail beside its own, and an
